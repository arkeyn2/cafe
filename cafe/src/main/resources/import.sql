...
INSERT INTO public.trago(id, estado_trago, iva, metodo_pago, nombre_trago, tipo_trago, valor_trago)	VALUES ( 1,'valido','0', 'efectivo', '---','alcohol','0');
INSERT INTO public.trago(id, estado_trago, iva, metodo_pago, nombre_trago, tipo_trago, valor_trago)	VALUES ( 2,'valido','3800', 'devito', 'trago 20 mil','alcohol','20000');
INSERT INTO public.trago(id, estado_trago, iva, metodo_pago, nombre_trago, tipo_trago, valor_trago)	VALUES ( 3,'valido','5700', 'credito', 'trago 30 mil','bebida','30000');
INSERT INTO public.trago(id, estado_trago, iva, metodo_pago, nombre_trago, tipo_trago, valor_trago)	VALUES ( 3,'valido','7600', 'credito', 'trago 40 mil','bebida','40000');
...
INSERT INTO public.servicios(id, detalle_servicio, estado_servicio, iva, metodo_pago, nombre_servicio, pieza, tipo_servicio, valor)	VALUES (1,'perro', 'activo', 0, 'efe', '---', 's', 'sad', 0);
INSERT INTO public.servicios(id, detalle_servicio, estado_servicio, iva, metodo_pago, nombre_servicio, pieza, tipo_servicio, valor)	VALUES (2,'perro', 'activo', 1000, 'efe', 'asd', 's', 'sad', 1000);


INSERT INTO public.acciones(id, adelanto, caja, comisiones, dia_activo, estado, estado_de_pago, fecha_dia, pendiente, tipo_accion, total_ganado, servicio_id, tragos_id, usuario_id) VALUES (1, 0, 0, 0, '2023-05-15', 'pagado', 'p', '2023-05-15', 's', 's', 0, 1, 2, 1);
INSERT INTO public.acciones(id, adelanto, caja, comisiones, dia_activo, estado, estado_de_pago, fecha_dia, pendiente, tipo_accion, total_ganado, servicio_id, tragos_id, usuario_id) VALUES (2, 0, 0, 0, '2023-05-15', 'pagado', 'p', '2023-05-15', 's', 's', 0, 1, 2, 1);